...
public class getUserByEmailProvider implements ArgumentsProvider {
    @Override
    public Stream<? extends Arguments> provideArguments(ExtensionContext context) throws Exception {
        ...
        return Stream.of(
                Arguments.of("systemadmin@gmail.com", false, filledList),
                Arguments.of("false@gmail.com", true, emptyList)
        );
    }
}
